...
(function ($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function processData() {
            var topSentry = Number.POSITIVE_INFINITY, bottomSentry = Number.NEGATIVE_INFINITY, i, j, k, m, length, s,
                points, ps, x, y, axis, val, f, p;
        ...
        function findNearbyItem(mouseX, mouseY, seriesFilter) {
            ...
            for (i = 0; i < series.length; ++i) {
                ...
                var s = series[i], axisx = s.xaxis, axisy = s.yaxis, points = s.datapoints.points,
                    ps = s.datapoints.pointsize, mx = axisx
