...
public class TemporalPublicationVisualizationRequestHandler implements
    ...
    public ResponseValues generateStandardVisualization(VitroRequest vitroRequest, Log log,
        ...
        return generateStandardVisualizationForPublicationTemporalVis(vitroRequest, log, dataset,
            entityURI);
    }
    ...
    private Map<String, String> getSubjectEntityAndGenerateDataResponse(
        ...
        Map<String, String> orgMostSpecificLabelMap =
            VisualizationCaches.organizationToMostSpecificLabel.get(rdfService);
        Map<String, String> personMostSpecificLabelMap =
            VisualizationCaches.personToMostSpecificLabel.get(rdfService);
            ...
            if (VisConstants.DataVisMode.JSON.equals(visMode)) {
                ...
                for (String subOrg : subOrgPublicationsMap.keySet()) {
                    ...
                    if (subOrgPublicationsMap.containsKey(subOrg)) {
                        List<List<Integer>> yearPubCounts = CounterUtils
                            .getObjectCountByYear(subOrgPublicationsMap.get(subOrg),
                                publicationToYearMap);
                    ...
                    entityJson
                        .setOrganizationTypes(Arrays.asList(type == null ? "Organization" : type));
                ...
                for (String person : orgPublicationsPeople) {
                    ...
                    if (personToPublicationMap.containsKey(person)) {
                        List<List<Integer>> yearPubCounts = CounterUtils
                            .getObjectCountByYear(personToPublicationMap.get(person),
                                publicationToYearMap);
                        entityJson.setYearToActivityCount(yearPubCounts);
                    } else {
                        entityJson.setYearToActivityCount(new ArrayList<List<Integer>>());
                ...
                fileData.put(DataVisualizationController.FILE_CONTENT_KEY,
                    mapper.writeValueAsString(subEntitiesJson));
                ...
                String outputFileName =
                    UtilityFunctions.slugify(entityLabel) + "_publications-per-year" + ".csv";
                fileData.put(DataVisualizationController.FILE_NAME_KEY, outputFileName);
                fileData.put(DataVisualizationController.FILE_CONTENT_TYPE_KEY,
                    "application/octet-stream");
                fileData
                    .put(DataVisualizationController.FILE_CONTENT_KEY, csvFileContent.toString());
            }
            return fileData;
        }
    }
    ...
    private TemplateResponseValues prepareStandaloneMarkupResponse(VitroRequest vreq,
        ...
        String organizationLabel =
            OrganizationUtilityFunctions.getEntityLabelFromDAO(vreq, entityURI);
