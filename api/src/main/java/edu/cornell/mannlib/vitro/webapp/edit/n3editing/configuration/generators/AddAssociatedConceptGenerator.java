 ...
 */
public class AddAssociatedConceptGenerator extends VivoBaseGenerator
    ...
    private Object getUserDefinedConceptUrl(VitroRequest vreq) {
        ...
        String generatorName =
            "edu.cornell.mannlib.vitro.webapp.edit.n3editing.configuration.generators.AddUserDefinedConceptGenerator";
    ...
    private List<AssociatedConceptInfo> getAssociatedConceptInfo(
        ...
        for (Individual conceptIndividual : concepts) {
            ...
            List<ObjectPropertyStatement> vocabList =
                conceptIndividual.getObjectPropertyStatements(RDFS.isDefinedBy.getURI());
            ...
            if (vocabList != null && vocabList.size() > 0) {
                ...
                Individual sourceIndividual =
                    EditConfigurationUtils.getIndividual(vreq, vocabSource);
            ...
            if (userGenerated) {
                ...
                info.add(
                    new AssociatedConceptInfo(conceptLabel, conceptUri, null, null, SKOSConceptType,
                        null, null));
            } else {
                ...
                HashMap<String, String> typeAndLabel =
                    this.getConceptSemanticTypeQueryResults(conceptIndividual.getURI(),
                        ModelAccess.on(vreq).getOntModel());
                ...
                info.add(
                    new AssociatedConceptInfo(conceptLabel, conceptUri, vocabSource, vocabLabel,
                        null, conceptSemanticTypeURI, conceptSemanticTypeLabel));
    ...
    private HashMap<String, String> getConceptSemanticTypeQueryResults(String conceptURI,
                                                                       OntModel ontModel) {
    ...
    public class AssociatedConceptInfo {
        ...
        private String conceptSemanticTypeURI;
            //For some services, such as UMLS, we have a semantic type associated
        private String conceptSemanticTypeLabel;

        public AssociatedConceptInfo(String inputLabel, String inputURI, String inputVocabURI,
                                     String inputVocabLabel, String inputType,
