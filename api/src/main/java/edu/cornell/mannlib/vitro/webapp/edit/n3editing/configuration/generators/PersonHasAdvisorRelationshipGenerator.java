...
public class PersonHasAdvisorRelationshipGenerator extends VivoBaseGenerator implements
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        conf.setN3Optional(Arrays.asList(n3ForNewAdviseeAssertion,
            ...
            n3ForNewSubjAreaAssertion,
            //this will include all the new information that needs to be captured
            n3ForStart,
            n3ForEnd));
        ...
        conf.setUrisOnform(
            Arrays.asList("advisingRelType", "existingSubjArea", "degree", "existingAdvisee"));
        conf.setLiteralsOnForm(Arrays
            .asList("advisingRelLabel", "subjAreaLabel", "adviseeLabel", "firstName", "lastName",
                "subjAreaLabelDisplay", "adviseeLabelDisplay"));
