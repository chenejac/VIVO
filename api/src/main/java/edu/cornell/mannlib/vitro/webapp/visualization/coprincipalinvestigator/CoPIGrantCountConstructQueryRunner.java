...
//				+ "?endDateForGrant core:dateTime ?endDateTimeValueForGrant . "
    ...
    private Model executeQuery(Set<String> constructQueries, RDFService rdfService) {
        ...
        for (String queryString : constructQueries) {
            ...
            try {
                is = rdfService
                    .sparqlConstructQuery(QueryConstants.getSparqlPrefixQuery() + queryString,
                        RDFService.ModelSerializationFormat.N3);
                constructedModel.read(is, null, RDFServiceUtils
                    .getSerializationFormatString(RDFService.ModelSerializationFormat.N3));
    ...
    private void populateConstructQueries(Set<String> constructQueries) {
        ...
        constructQueries
            .add(generateConstructQueryForInvestigatorRoleOfProperty(
                this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>",
                "core:InvestigatorRole"));
        constructQueries
        ...
        constructQueries
            .add(generateConstructQueryForInvestigatorRoleOfProperty(
                this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>",
                "core:PrincipalInvestigatorRole"));
        constructQueries
            .add(generateConstructQueryForCoPrincipalInvestigatorRoleOfProperty(
                this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>",
                "core:PrincipalInvestigatorRole"));
