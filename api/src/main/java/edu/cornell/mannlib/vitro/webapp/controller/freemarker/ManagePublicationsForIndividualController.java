...
@WebServlet(name = "ManagePublicationsForIndividualController", urlPatterns = {
    "/managePublications"})
public class ManagePublicationsForIndividualController extends FreemarkerHttpServlet {

    private static final Log log =
        LogFactory.getLog(ManagePublicationsForIndividualController.class.getName());
    ...
    HashMap<String, List<Map<String, String>>> getPublications(String subjectUri,
                                                               VitroRequest vreq) {
        ...
        HashMap<String, List<Map<String, String>>> subclassToPublications =
        ...
        try {
            ...
            while (results.hasNext()) {
                ...
                if (!subclassToPublications.containsKey(subclass)) {
                    subclassToPublications.put(subclass,
                        new ArrayList<Map<String, String>>()); //list of publication information
                }
