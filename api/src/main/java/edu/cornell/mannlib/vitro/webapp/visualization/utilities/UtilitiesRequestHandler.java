...
public class UtilitiesRequestHandler implements VisualizationRequestHandler {
    ...
    public Object generateAjaxVisualization(VitroRequest vitroRequest,
        ...
        if (VisualizationFrameworkConstants.PROFILE_INFO_UTILS_VIS_MODE
            ...
            ThumbnailInformationConsumer consumer =
                new ThumbnailInformationConsumer(vitroRequest, fieldLabelToOutputFieldLabel);
            ...
            numberOfPublicationsQueryHandler
                .sparqlSelectQuery(vitroRequest.getRDFService(), consumer);
            ...
            ObjectProperty predicate =
                ModelUtils.getPropertyForRoleInClass(grantType, vitroRequest.getWebappDaoFactory());
            ...
            if (StringUtils.isNotBlank(individualLocalName)) {
                ...
                return UrlBuilder
                    .getUrl(VisualizationFrameworkConstants.SHORT_URL_VISUALIZATION_REQUEST_PREFIX)
            ...
            HighetTopLevelOrgTemporalGraphURLConsumer consumer =
                new HighetTopLevelOrgTemporalGraphURLConsumer(vitroRequest,
                    fieldLabelToOutputFieldLabel);
            highestLevelOrganizationQueryHandler
                .sparqlSelectQuery(vitroRequest.getRDFService(), consumer);
    ...
    private static class NumPubsForIndividualConsumer extends ResultSetConsumer {
        ...
        protected void processQuerySolution(QuerySolution qs) {
            ...
            if (numberOfPublicationsNode != null) {
                queryResult.addEntry("numOfPublications",
    ...
    private static class ThumbnailInformationConsumer extends ResultSetConsumer {
        ...
        ThumbnailInformationConsumer(VitroRequest vitroRequest,
                                     Map<String, String> fieldLabelToOutputFieldLabel) {
    ...
    private class HighetTopLevelOrgTemporalGraphURLConsumer extends ResultSetConsumer {
        ...
        HighetTopLevelOrgTemporalGraphURLConsumer(VitroRequest vitroRequest,
                                                  Map<String, String> fieldLabelToOutputFieldLabel) {
            this.vitroRequest = vitroRequest;
            this.fieldLabelToOutputFieldLabel = fieldLabelToOutputFieldLabel;
        }
        ...
        protected void processQuerySolution(QuerySolution qs) {
            ...
            if (organizationNode != null) {
                String individualLocalName = UtilityFunctions
                    .getIndividualLocalName(organizationNode.toString(), vitroRequest);

                if (StringUtils.isNotBlank(individualLocalName)) {

                    topLevelURL = UrlBuilder.getUrl(
                        VisualizationFrameworkConstants.SHORT_URL_VISUALIZATION_REQUEST_PREFIX)
