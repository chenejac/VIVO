...
public class InternalClassesDataGetter extends IndividualsForClassesDataGetter {
    ...
    protected Map<String, Object> getClassIntersectionsMap(Model displayModel) {
        ...
        try {
            Query individualsForClassesInternalQuery =
                QueryFactory.create(individualsForClassesInternalQueryString);
            QueryExecution qexec = QueryExecutionFactory
                .create(individualsForClassesInternalQuery, displayModel, initialBindings);
            try {
