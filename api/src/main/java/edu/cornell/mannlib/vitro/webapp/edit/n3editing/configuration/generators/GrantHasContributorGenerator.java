...
public class GrantHasContributorGenerator extends VivoBaseGenerator
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session)
        ...
        conf.setN3Optional(Arrays
            .asList(n3ForNewPerson, n3ForExistingPerson, firstNameAssertion, lastNameAssertion));
        ...
        conf.setLiteralsOnForm(
            Arrays.asList("personLabel", "personLabelDisplay", "firstName", "lastName"));
