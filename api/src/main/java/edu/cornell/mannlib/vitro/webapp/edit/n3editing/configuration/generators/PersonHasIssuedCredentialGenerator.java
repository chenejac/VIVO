...
/*        "?existingCredential a <" + credentialTypeClass + ">  . \n" +
    ...
    final static String existingYearCredentialedPrecisionQuery =
        "SELECT ?existingYearCredentialedPrecision WHERE { \n" +
            ...
            "  ?yearCredentialed <" + dateTimePrecision +
            "> ?existingYearCredentialedPrecision . }";
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        conf.setUrisOnform(
            Arrays.asList("existingCredential", "issuedCredentialType", "credentialType"));
        conf.setLiteralsOnForm(
            Arrays.asList("yearCredentialedDisplay", "credentialLabel", "credentialLabelDisplay"));
        ...
        conf.addSparqlForExistingUris("yearCredentialed-precision",
            existingYearCredentialedPrecisionQuery);
        ...
        conf.addValidator(
            new AutocompleteRequiredInputValidator("existingCredential", "credentialLabel"));
