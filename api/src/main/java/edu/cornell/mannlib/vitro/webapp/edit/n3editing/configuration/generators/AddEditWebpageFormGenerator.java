 ...
 */
public class AddEditWebpageFormGenerator extends BaseEditConfigurationGenerator
    ...
    protected EditConfigurationVTwo setupConfig(VitroRequest vreq, HttpSession session)
        throws Exception {
        ...
        config
            .addUrisInScope("webpageProperty", list("http://purl.obolibrary.org/obo/ARG_2000028"));
        config
            .addUrisInScope("inverseProperty", list("http://purl.obolibrary.org/obo/ARG_2000029"));
        config.addUrisInScope("linkUrlPredicate", list("http://www.w3.org/2006/vcard/ns#url"));
        config.addUrisInScope("linkLabelPredicate",
    ...
    private Object getName(EditConfigurationVTwo config, VitroRequest vreq) {
        Individual ind = vreq.getWebappDaoFactory().getIndividualDao()
