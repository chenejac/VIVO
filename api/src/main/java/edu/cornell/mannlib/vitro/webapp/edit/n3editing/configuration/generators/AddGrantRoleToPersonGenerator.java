...
public class AddGrantRoleToPersonGenerator implements EditConfigurationGenerator {
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session) {
        ...
        editConfiguration
            .addValidator(new AutocompleteRequiredInputValidator("existingGrant", "grantLabel"));
    ...
    public String getRoleToGrantPredicate(VitroRequest vreq) {
        ObjectProperty predicate =
            ModelUtils.getPropertyForRoleInClass(getGrantType(), vreq.getWebappDaoFactory());
