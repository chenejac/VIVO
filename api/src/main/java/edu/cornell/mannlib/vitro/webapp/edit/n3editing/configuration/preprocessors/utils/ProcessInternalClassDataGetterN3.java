...
public class ProcessInternalClassDataGetterN3 extends ProcessIndividualsForClassesDataGetterN3 {
    ...
    private List<String> addInternalClassN3(int counter) {
        ...
        internalClassN3
            .add(dataGetterVar + " <" + DisplayVocabulary.RESTRICT_RESULTS_BY_INTERNAL + "> " +
    ...
    public void populateExistingValues(String dataGetterURI, int counter, OntModel queryModel) {
        ...
        try {
            ...
            log.error("Exception occurred in retrieving existing values with query " + querystr,
                ex);
        }
    ...
    protected String getExistingValuesInternalClass(String dataGetterURI) {
        String query = this.getSparqlPrefix() +
            " SELECT ?classGroup  ?individualForClass ?internalClass WHERE {" +
            "<" + dataGetterURI + "> <" + DisplayVocabulary.FOR_CLASSGROUP + "> ?classGroup  . \n" +
            "OPTIONAL {<" + dataGetterURI + "> <" + DisplayVocabulary.GETINDIVIDUALS_FOR_CLASS +
            "> ?individualForClass . }\n" +
            "OPTIONAL {<" + dataGetterURI + "> <" + DisplayVocabulary.RESTRICT_RESULTS_BY_INTERNAL +
            "> ?internalClass .} \n" +
            "}";
        return query;
    }
    ...
    public ObjectNode getExistingValuesJSON(String dataGetterURI, OntModel queryModel,
        ...
        ((ProcessClassGroupDataGetterN3) this)
            .getExistingClassesInClassGroup(context, dataGetterURI, jObject);
        return jObject;
    }

    private void getExistingClassGroupAndInternalClass(String dataGetterURI, ObjectNode jObject,
                                                       OntModel queryModel) {
        String querystr = getExistingValuesInternalClass(dataGetterURI);
        QueryExecution qe = null;
        Literal internalClassLiteral = null;
