...
public class ProcessInternalClasses extends ProcessIndividualsForClasses {
    ...
    @Override
    protected void populateRestrictedClasses(Map<String, Object> pageData,
    ...
    public Model processSubmission(VitroRequest vreq, Resource dataGetterResource) {
        String dataGetterTypeUri =
            DataGetterUtils.generateDataGetterTypeURI(InternalClassesDataGetter.class.getName());
