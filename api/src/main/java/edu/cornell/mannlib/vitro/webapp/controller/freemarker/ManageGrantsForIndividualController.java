...
public class ManageGrantsForIndividualController extends FreemarkerHttpServlet {
    ...
    private static final Log log =
        LogFactory.getLog(ManageGrantsForIndividualController.class.getName());
    ...
    HashMap<String, List<Map<String, String>>> getGrants(String subjectUri, VitroRequest vreq) {
        ...
        HashMap<String, List<Map<String, String>>> subclassToGrants =
        ...
        try {
            ...
            while (results.hasNext()) {
                ...
                if (subclassUri != null) {
                    ...
                    String subclass =
                        ((vClass.getName() == null) ? subclassUriStr : vClass.getName());
                    if (!subclassToGrants.containsKey(subclass)) {
                        subclassToGrants.put(subclass,
                            new ArrayList<Map<String, String>>()); //list of grant information
                    }
