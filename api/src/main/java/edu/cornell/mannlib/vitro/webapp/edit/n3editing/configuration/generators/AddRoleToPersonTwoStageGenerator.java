 ...
 * template
 */
public abstract class AddRoleToPersonTwoStageGenerator extends BaseEditConfigurationGenerator
...
//    	        getN3ForActivityType(),
        ...
        //Add validator
        editConfiguration
            .addValidator(new DateTimeIntervalValidationVTwo("startField", "endField"));
        editConfiguration.addValidator(new AntiXssValidation());
        editConfiguration.addValidator(
            new AutocompleteRequiredInputValidator("existingRoleActivity", "activityLabel"));
    ...
    private List<String> getN3ForExistingRoleActivity() {
        ...
        n3ForExistingRoleActivity
            .add("?role " + getRoleToActivityPlaceholder() + " ?existingRoleActivity .\n" +
     ...
     * @throws Exception
     */
    protected String getActivityTypeQueryForConstantOptions(VitroRequest vreq,
                                                            ConstantFieldOptions fieldOptions)
        throws Exception {
     ...
     */
    protected String getActivityTypeQueryForChildVClassOptions(VitroRequest vreq,
                                                               ChildVClassesOptions opts) {
     ...
     */
    protected String getActivityTypeQueryForIndividualsViaClassGroupOptions(VitroRequest vreq,
                                                                            IndividualsViaClassGroupOptions opts) {
    ...
    private String getActivityTypeQuery(VitroRequest vreq) throws Exception {
        ...
        try {
            ...
            if (fieldOpts instanceof ConstantFieldOptions) {
                activityTypeQuery = getActivityTypeQueryForConstantOptions(vreq,
                    (ConstantFieldOptions) fieldOpts);                //
            } else if (fieldOpts instanceof ChildVClassesOptions) {
                activityTypeQuery = getActivityTypeQueryForChildVClassOptions(vreq,
                    (ChildVClassesOptions) fieldOpts);
            } else if (fieldOpts instanceof IndividualsViaClassGroupOptions) {
                activityTypeQuery = getActivityTypeQueryForIndividualsViaClassGroupOptions(vreq,
                    (IndividualsViaClassGroupOptions) fieldOpts);
            }
        } catch (Exception ex) {
        ...
        activityTypeQuery = QueryUtils
            .replaceQueryVar(activityTypeQuery, "predicate", getRoleToActivityPlaceholderName());
    ...
    private void setFields(EditConfigurationVTwo editConfiguration, VitroRequest vreq,
                           String predicateUri) throws Exception {
