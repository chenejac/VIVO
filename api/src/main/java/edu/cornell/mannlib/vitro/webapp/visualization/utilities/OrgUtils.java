...
public class OrgUtils {
    public static Map<String, String> getParentURIsToLabel(String org,
        ...
        if (!StringUtils.isEmpty(org)) {
            for (Map.Entry<String, Set<String>> orgMapEntry : subOrgMap.entrySet()) {
                ...
                if (subOrgs != null && subOrgs.contains(org) &&
                    orgLabelMap.containsKey(orgMapEntry.getKey())) {
                    parentURIsToLabel
                        .put(orgMapEntry.getKey(), orgLabelMap.get(orgMapEntry.getKey()));
                }
            }
        }
    ...
    public static void getObjectMappingsForOrgAndSubOrgs(
        ...
        if (subOrgMap.containsKey(orgUri)) {
            for (String topSubOrg : subOrgMap.get(orgUri)) {
                ...
                Set<String> fullSubOrgs =
                    OrgUtils.orgAndAllSubOrgs(new HashSet<String>(), topSubOrg, subOrgMap);
    ...
    private static Set<String> orgAndAllSubOrgs(Set<String> allSubOrgs, String org,
                                                Map<String, Set<String>> subOrgMap) {
