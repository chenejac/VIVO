...
public class PersonHasAdviseeRelationshipGenerator extends VivoBaseGenerator implements
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        conf.setUrisOnform(
            Arrays.asList("advisingRelType", "existingSubjArea", "degree", "existingAdvisor"));
        conf.setLiteralsOnForm(Arrays
            .asList("advisingRelLabel", "subjAreaLabel", "advisorLabel", "firstName", "lastName",
                "subjAreaLabelDisplay", "advisorLabelDisplay"));
