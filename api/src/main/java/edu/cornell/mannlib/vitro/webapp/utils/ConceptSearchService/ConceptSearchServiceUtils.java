...
public class ConceptSearchServiceUtils {
    ...
    private static final String AgrovocVocabSource =
        "http://aims.fao.org/aos/agrovoc/agrovocScheme";
    private static final String GemetVocabSource =
    ...
    public static HashMap<String, VocabSourceDescription> getVocabSources() {
        ...
        map.put(AgrovocVocabSource,
            new VocabSourceDescription("AGROVOC", AgrovocVocabSource, "http://www.fao.org/agrovoc/",
