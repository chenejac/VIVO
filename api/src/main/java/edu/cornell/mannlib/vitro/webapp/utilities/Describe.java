...
public class Describe {
    ...
    public static void main(String[] args) {
        ...
        model.read(
            "C:\\VIVO-Trad-ecosysteme\\vivo\\home\\rdf\\applicationMetadata\\firsttime\\classgroups_fr_CA.rdf");
        model.read(
            "C:\\VIVO-Trad-ecosysteme\\vivo\\home\\rdf\\applicationMetadata\\firsttime\\classgroups.rdf");
    ...
    private static void showVitroClassGroupequipmentLabels(OntModel model, String message) {
        ...
        List<Statement> stmts =
            model.listStatements(ResourceFactory.createResource(uri), RDFS.label, (RDFNode) null)
                .toList();
