 ...
 */
public class ManageWebpagesForIndividualGenerator extends BaseEditConfigurationGenerator
    ...
    private List<Map<String, String>> getWebpages(String subjectUri, VitroRequest vreq) {
        ...
        try {
            String constructStr =
                QueryUtils.subUriForQueryVar(WEBPAGE_MODEL, "subject", subjectUri);
             ...
             */
            String queryStr =
                QueryUtils.subUriForQueryVar(this.getQuery(vreq), "subject", subjectUri);
