...
public class PersonPublicationCountRequestHandler implements
    ...
    public ResponseValues generateVisualizationForShortURLRequests(
        ...
        throw new UnsupportedOperationException(
            "Person Publication Count Visualization does not provide "
                + "Short URL Response.");
    }
    ...
    private TemplateResponseValues prepareDynamicResponse(VitroRequest vreq,
        ...
        body.put("requestingTemplate",
            requestingTemplate); /* tlw72 -- Added in 1.6 for multi-view support.*/
