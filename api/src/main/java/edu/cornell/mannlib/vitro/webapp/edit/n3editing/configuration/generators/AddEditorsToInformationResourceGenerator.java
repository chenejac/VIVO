 ...
 */
public class AddEditorsToInformationResourceGenerator extends VivoBaseGenerator
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        //add validators
        editConfiguration
            .addValidator(new FirstAndLastNameValidator("personUri", I18n.bundle(vreq)));
    ...
    public void addFormSpecificData(EditConfigurationVTwo editConfiguration, VitroRequest vreq) {
        ...
        formSpecificData.put("existingEditorInfo",
            getExistingEditorships(editConfiguration.getSubjectUri(), vreq));
    ...
    private List<EditorshipInfo> getExistingEditorships(String subjectUri, VitroRequest vreq) {
        ...
        try {
            String constructStr =
                QueryUtils.subUriForQueryVar(EDITORSHIPS_MODEL, "subject", subjectUri);

            Model constructedModel = ModelFactory.createDefaultModel();
            rdfService.sparqlConstructQuery(constructStr, constructedModel);

            String queryStr =
                QueryUtils.subUriForQueryVar(this.getEditorshipsQuery(), "subject", subjectUri);
    ...
    private List<EditorshipInfo> getEditorshipInfo(
        ...
        for (Map<String, String> editorship : editorships) {
            ...
            EditorshipInfo aaInfo =
                new EditorshipInfo(editorshipUri, editorshipName, editorUri, editorName);
            info.add(aaInfo);
        }
        log.debug("info = " + info);
        return info;
