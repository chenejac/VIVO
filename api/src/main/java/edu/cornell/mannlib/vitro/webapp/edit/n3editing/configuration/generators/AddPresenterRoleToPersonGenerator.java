...
public class AddPresenterRoleToPersonGenerator extends VivoBaseGenerator implements
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        conf.setUrisOnform(
            Arrays.asList("existingPresentation", "existingConference", "presentationType"));
        conf.setLiteralsOnForm(Arrays
            .asList("presentationLabel", "presentationLabelDisplay", "conferenceLabel",
                "conferenceLabelDisplay", "roleLabel"));
        ...
        conf.addValidator(
            new AutocompleteRequiredInputValidator("existingPresentation", "presentationLabel"));
        prepare(vreq, conf);
        return conf;
    }
