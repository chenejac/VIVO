...
public class OrganizationHasPositionHistoryGenerator extends VivoBaseGenerator
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        conf.setN3Optional(Arrays
            .asList(N3_NEW_PERSON, N3_EXISTING_PERSON, N3_NEW_START_NODE, N3_NEW_END_NODE,
                N3_NEW_FIRST_NAME, N3_NEW_LAST_NAME));
        ...
        conf.setLiteralsOnForm(Arrays
            .asList("positionTitle", "personLabelDisplay", "personLabel", "firstName", "lastName"));
