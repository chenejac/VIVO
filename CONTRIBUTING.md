Contributing to VIVO
=============================

VIVO is a free and open project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into VIVO itself.

Bug reports
-----------

If you think you have found a bug in VIVO, please search our [issues list](https://github.com/vivo-project/VIVO/issues) on GitHub in case a similar issue has already been opened.

Provide as much information as you can, regarding your configuration, environment, and description how to reproduce the bug. In other words, please try to provide as much as possible information into the [Bug report template](https://github.com/vivo-project/VIVO/issues/new?assignees=&labels=&projects=&template=bug_report.md&title=).

Feature requests
----------------

If you find yourself wishing for a feature that doesn't exist in VIVO, you might be not alone. Please search our [features list](https://github.com/vivo-project/VIVO/issues) on GitHub in case a similar feature has already been requested. If that is the case, please add your comments if any. Otherwise, please [open a new ticket for requested feature](https://github.com/vivo-project/VIVO/issues/new?assignees=&labels=&projects=&template=feature_request.md&title=). Please, provide as much details as possible of requested feature. 
